...
def _timeout_seconds() -> float:
    # O alvo continua ser <3s com o prefixo em cache; 10s é somente margem para
    # a primeira inferência após restart/warmup, evitando abortar uma ação segura
    # quando o modelo ainda está preenchendo o KV cache.

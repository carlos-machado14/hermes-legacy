...
chmod +x install-core-v2.sh install-cron-manager.sh install-fast-router.sh set-brazil-timezone.sh migrate-crons-local.sh
...
echo
echo 'OK: Hermes Core v2.1 + Fast Router v9 + Cron Manager + recovery instalados.'

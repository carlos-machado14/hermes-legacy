...
printf '\n=== Hermes Core v3 Personal Agent Upgrade ===\n'
...
"$HOME/.hermes/core-v2/venv/bin/python" "$HOME/.hermes/core-v2/hermes_core.py" 'meus objetivos'
"$HOME/.hermes/core-v2/venv/bin/python" "$HOME/.hermes/core-v2/hermes_core.py" 'minhas tarefas'

echo
echo 'OK: Hermes Core v3 Personal Agent atualizado; dados e configuracoes do usuario foram preservados.'
echo 'Novidades: Goals, Tasks, Personal Memory, Opportunity Engine, Workflows, Research e Skill Registry.'

...
printf '\n=== Hermes Core v4.1 Autonomous Web Research Upgrade ===\n'
...
chmod +x install-core-v2.sh install-v4-runtime.sh install-web-research.sh install-conversation-layer.sh install-cron-manager.sh install-fast-router.sh install-gateway-fastpath-plugin.sh
...
echo
echo 'OK: Hermes v4.1 Durable Missions + pesquisa web real + Playwright + crawler + auditor instalados.'
echo 'Novidades: SearXNG local, pesquisa deterministica, navegador headless, coleta de contatos e auditoria de sites.'
